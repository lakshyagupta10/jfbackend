...
Route::group(['namespace'=>'Admin', 'prefix'=>'admin'],function(){
 ...
 //city
      ...
      Route::post('vendorcat-sort','VendorCategoryController@update')->name('vendorcat-sort');
      ...
      Route::get('hidevendor/{vendor_category_id}','VendorCategoryController@hidevendor')->name('hidevendor');
      Route::post('moveupvendor/{vendor_category_id}','VendorCategoryController@moveupvendor')->name('moveupvendor');
      Route::post('movedownvendor/{vendor_category_id}','VendorCategoryController@movedownvendor')->name('movedownvendor');
...
//logo
      ...
      Route::get('editparbanner/{banner_id}','BannerController@editparbanner')->name('editparbanner');
      Route::get('editsubsbanner/{banner_id}','BannerController@editsubsbanner')->name('editsubsbanner');
      Route::get('editbigbanner/{banner_id}','BannerController@editbigbanner')->name('editbigbanner');
      Route::get('edittopmessagebanner/{banner_id}','BannerController@edittopmessagebanner')->name('edittopmessagebanner');
      Route::get('editclosedbanner/{banner_id}','BannerController@editclosedbanner')->name('editclosedbanner');
      Route::post('updatebanner/{banner_id}','BannerController@updatebanner')->name('updatebanner');
      Route::post('updateparbanner/{banner_id}','BannerController@updateparbanner')->name('updateparbanner');
      Route::post('updatesubsbanner/{banner_id}','BannerController@updatesubsbanner')->name('updatesubsbanner');
      Route::post('updatebigbanner/{banner_id}','BannerController@updatebigbanner')->name('updatebigbanner');
      Route::post('updateclosedbanner/{banner_id}','BannerController@updateclosedbanner')->name('updateclosedbanner');
      Route::post('updatetopmessagebanner/{banner_id}','BannerController@updatetopmessagebanner')->name('updatetopmessagebanner');
    ...
    //Vendor logout
      ...
      Route::get('logout','ProfileController@vendorLogout')->name('vendor-logout');
	    ...
	    Route::post('update_incentive_order', 'Incentive_orderController@update_incentive_order')->name('update_incentive_order');
         ...
         Route::post('cat-sort','CategoryController@update')->name('cat-sort');
        ...
        Route::post('moveupcat/{category_id}','CategoryController@moveupcat')->name('moveupcat');
        Route::post('movedowncat/{category_id}','CategoryController@movedowncat')->name('movedowncat');
        Route::get('hidecat/{category_id}','CategoryController@hidecat')->name('hidecat');
         // for sub-category
         ...
         Route::get('taxes','subcatController@taxes')->name('taxes');
        ...
        Route::post('moveupsubcat/{subcat_id}','subcatController@moveupsubcat')->name('moveupsubcat');
        Route::post('movedownsubcat/{subcat_id}','subcatController@movedownsubcat')->name('movedownsubcat');
        Route::get('hidesubcat/{subcat_id}','subcatController@hidesubcat')->name('hidesubcat');
         // for Products
         ...
         Route::post('vendorproduct','ProductController@searchproduct')->name('vendorproduct');
...
Route::group(['namespace'=>'Resturant', 'prefix'=>'restaurant'],function(){
    ...
    //Vendor logout
      ...
      Route::get('packagingcharge','ProfileController@packagingcharge')->name('packagingcharge');
      Route::post('updatepackagingcharge/{id}','ProfileController@updatepackagingcharge')->name('updatepackagingcharge');
      ...
      // for category
          ...
          Route::get('resturanttaxes','CategoryController@taxes')->name('resturanttaxes');
         ...
         Route::post('resturantproduct','ProductController@searchproduct')->name('resturantproduct');
...
Route::group(['namespace'=>'Pharmacy', 'prefix'=>'pharmacy'],function(){
    ...
    //Vendor logout
      ...
      // for category
         ...
         Route::post('pharmacysearchproduct','ProductController@searchproduct')->name('pharmacysearchproduct');
...
Route::group(['namespace'=>'Cityadmin', 'prefix'=>'cityadmin'],function(){
    ...
    /// for cityadmin home
      ...
      Route::get('settings', 'HomeController@cityadminsettings')->name('cityadmin-settings');
      Route::post('cityadminsettings/{id}', 'HomeController@cityadminupdatesettings')->name('cityadminsettings');
    ...
    Route::post('CNotification_to_store_Send', 'notificationController@CNotification_to_store_Send')->name('CNotification_to_store_Send');
       ...
       Route::get('cdelivery_boy_comission','delivery_boy_comissionController@cdelivery_boy_comission')->name('cdelivery_boy_comission');
         ...
         //delivery charges
          ...
          Route::post('add-delivery_charge_vendor/{id}','delivery_chargesController@add_delivery_charge_vendor')->name('add-delivery_charge_vendor');
          Route::get('delivery_charges','delivery_chargesController@delivery_charges')->name('delivery_charges');
          Route::get('delivery_charges/add','delivery_chargesController@Adddelivery_charge')->name('add-delivery_charge');
          Route::get('delivery_charges/add/{id}','delivery_chargesController@Adddelivery_charges')->name('add-delivery_charges');
          Route::post('delivery_charges/add/new/{id}','delivery_chargesController@AddNewdelivery_charges')->name('AddNewdelivery_charges');
          Route::get('delivery_charges/edit/{id}','delivery_chargesController@Editdelivery_charges')->name('edit-delivery_charges');
          Route::get('delivery_charge/edit/{id}','delivery_chargesController@Editdelivery_charge')->name('edit-delivery_charge');
          Route::get('delivery_charge/delete/{id}','delivery_chargesController@deletedelivery_charge')->name('delete-delivery_charge');
          Route::post('delivery_charges/update/{id}','delivery_chargesController@Updatedelivery_charges')->name('update-delivery_charges');
          Route::get('delivery_charges/delete/{id}','delivery_chargesController@deletedelivery_charges')->name('delete-delivery_charges');


          Route::get('parcel_delivery_charges','delivery_chargesController@parcel_delivery_charges')->name('parcel_delivery_charges');
          Route::get('parcel_delivery_charges/add','delivery_chargesController@Addparcel_delivery_charges')->name('add-parcel_delivery_charges');
          Route::post('parcel_delivery_charges/add/new','delivery_chargesController@AddNewparcel_delivery_charges')->name('AddNewparcel_delivery_charges');
          Route::get('parcel_delivery_charges/edit/{id}','delivery_chargesController@Editparcel_delivery_charges')->name('edit-parcel_delivery_charges');
          Route::get('parcel_delivery_charges/delete/{id}','delivery_chargesController@deleteparceldelivery_charge')->name('delete-parcel_delivery_charges');
          Route::post('parcel_delivery_charges/update/{id}','delivery_chargesController@Updateparcel_delivery_charges')->name('update-parcel_delivery_charges');
        /// for bulk upload
        // Route::post('bulk_upload', 'ImportExcelController@import')->name('bulk_upload');
        //subs
        Route::get('subscriptionlist', 'subController@sublist')->name('subscriptionlist');
        Route::get('subscriptionstores', 'subController@substores')->name('subscriptionstores');
        Route::get('add-substore', 'subController@addsubstore')->name('add-substore');
        Route::post('addsubstore', 'subController@addnewsubstore')->name('addsubstore');
        Route::get('delete-substore/{id}', 'subController@deletesubstore')->name('delete-substore');
        Route::get('add-subplan', 'subController@addsubplan')->name('add-subplan');
        Route::post('addsubplan', 'subController@addnewsubplan')->name('addsubplan');
        Route::get('deletesubplan/{id}', 'subController@deletesubplan')->name('deletesubplan');
        Route::get('subscriptionplan/{id}', 'subController@subplan')->name('subscriptionplan');
        Route::get('subscriptionplans', 'subController@subplans')->name('subscriptionplans');
        Route::post('subscriptionsettings/{id}', 'subController@subsettings')->name('subscriptionsettings');
        Route::get('delete-subscriber', 'subController@deletesubscriber')->name('delete-subscriber');
...
Route::group(['prefix'=>'api','namespace'=>'Api'],function(){
    ...
    Route::get('subsbanner', 'AdminBannerController@subsbanner');
    Route::get('parbanner', 'AdminBannerController@parbanner');
    Route::get('bigbanner', 'AdminBannerController@bigbanner');
    ...
    //for Nearby Store
    Route::post('checkstorelocation', 'NearbystoreController@checkstorelocation');
    Route::post('nearbystore', 'NearbystoreController@nearbystore');
    Route::post('getdd', 'NearbystoreController@getDrivingDistance');
    Route::post('nearbyrest', 'NearbystoreController@nearbyrest');
     //order
    Route::post('order', 'OrderController@order');
    Route::post('ordercharges', 'OrderController@ordercharges');
    Route::post('servicecharges', 'OrderController@servicecharges');
    ...
    Route::post('upload_id', 'UserController@upload_id');
    Route::post('check_id', 'UserController@check_id');
    ...
    Route::get('vendorcategorylist', 'VendorCategoryController@vendorcategorylist');
    Route::get('adminsettings', 'VendorCategoryController@adminsettings');
    Route::get('top_message_banner', 'VendorCategoryController@top_message_banner');
    Route::get('closed_banner', 'VendorCategoryController@closed_banner');
    ...
    //for product search
    Route::post('autocomplete', 'searchController@googleautocomplete');
    Route::post('search_keyword', 'searchController@searchingFor');
    Route::post('search', 'searchController@searching');
    Route::post('restsearch', 'searchController@restsearching');
    Route::post('storesearch', 'searchController@storesearch');
    Route::post('searchrest', 'searchController@searchingrest');
   ...
   // store
    ...
    Route::post('store_order_details', 'StoreOrderController@store_order_detials');
    Route::post('store_cancel_order', 'StoreOrderController@store_cancel_order');
    Route::post('store_approve_order', 'StoreOrderController@store_approve_order');
    ...
    Route::post('rest_category','StoreProductController@rest_category');
    Route::post('rest_addcategory','StoreProductController@rest_addcategory');
    Route::post('rest_editcategory','StoreProductController@rest_editcategory');
    Route::post('rest_deletecategory','StoreProductController@rest_deletecategory');

    Route::post('store_subcategory','StoreProductController@store_subcategory');
    Route::post('store_addsubcategory','StoreProductController@store_addsubcategory');
    Route::post('store_addcategory','StoreProductController@store_addcategory');
    Route::post('store_editsubcategory','StoreProductController@store_editsubcategory');
    Route::post('store_editcategory','StoreProductController@store_editcategory');
    Route::post('store_deletesubcategory','StoreProductController@store_deletesubcategory');
    Route::post('store_deletecategory','StoreProductController@store_deletecategory');
    ...
    Route::post('checksubs', 'subController@checksubs');
    Route::get('subsstore', 'subController@subsstore');
    ...
    Route::post('ordersfortodaydetails', 'DriverOrderController@ordersfortodaydetails');
    ...
    Route::post('restorderdetails', 'ResturantOrderController@orderdetails');

    //Restaurant Vendor/////
    Route::post('vendor_today_order', 'RestaurantVendorOrderController@vendor_today_order');
    Route::post('vendor_order_details', 'RestaurantVendorOrderController@vendor_order_details');
    ...
    Route::post('pharmacy_deleteaddon', 'Pharmacy_VendorProductController@pharmacy_deleteaddon');
       ...
       Route::post('pharmacy_today_order_count', 'PharmacyDriverOrderController@pharmacy_today_order_count');
        ...
        Route::post('parcel_banner', 'AdminBannerController@parcel_banner');
                ...
                Route::post('parcel_check_location', 'ParcelDetailController@parcel_check_location');
        ...
        Route::post('parceldetails', 'ParcelDetailController@parceldetails');
        ...
        Route::post('parcel_today_order', 'ParcelDetailController@parcel_today_order');
        Route::post('parcel_store_order', 'ParcelDetailController@parcel_store_order');
        ...
        Route::post('parcel_complete_order', 'ParcelVendorController@parcel_complete_order');
	...
	Route::get('delete-city/{id}','CityController@Deletecity');
	   ...
	   // Route::post('update_incentive_order', 'Incentive_orderController@update_incentive_order')->name('update_incentive_order');
        ...
        //  Route::get('parceldeletesubcat/{subcat_id}','subcatController@resturantdeletesubcat')->name('parceldeletesubcat');
         ...
         Route::post('parcelsearchproduct','ProductController@searchproduct')->name('parcelsearchproduct');
