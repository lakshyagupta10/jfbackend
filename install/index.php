...
<html>
  <head>
    <meta charset="utf-8" />
    <title>GoMarket - Installer</title>
      ...
      <div class="column is-6 is-offset-3">
        ...
        <div class="box">
          ...
          <form action="index.php?step=1" method="POST">
            ...
            <input type="hidden" name="lcscs" id="lcscs" value="<?php echo "success" ?>">
            <div style='text-align: right;'>
...
fclose($myfile);
          ...
          <center>
            ...
            <p><strong>
              ...
              ?>
              <a href="<?php echo str_replace("install/", "", $base); ?>admin">Click Here to go</a>
            </strong></p><br>
          </center>
          <?php
          }
  ...
  <div class="content has-text-centered">
    <p>
      Copyright <?php echo date('Y'); ?> GoMarket, All rights reserved.
    </p>
    <br>
  </div>
</body>
