...
trait SendSms {
    ...
    if($smsby->status==1){       
       ...
       $message1 = $getInvitationMsg;
        ...
        //     )
        // );
        $senderId = "+12534610673";
        $authKey = "AC1def16409d6e41f043c30268e13edaab:e064f69eecc0aa6be9160f527fe8ec37";
        $url="https://api.twilio.com/2010-04-01/Accounts/AC1def16409d6e41f043c30268e13edaab/Messages.json";
        $postData = array(
                            'u' => $authKey,
                            'To' => $user_phone,
                            'Body' => $message1,
