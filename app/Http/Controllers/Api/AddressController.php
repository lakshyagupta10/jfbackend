...
class AddressController extends Controller
{
     public function address(Request $request)
    {
            ...
            $lng = $request->lng;
            $status= 1;
             $address = $house_no .",".  $street .",".  $city_name .",".  $state .",". $pin; 
            $added_at= Carbon::Now();
...
public function edit_add(Request $request)
  ...
  $vendor = DB::table('vendor')
    ...
    $app1 = DB::table('user_address')
            ...
            ->select('user_address.address_id','user_address.city_id','user_address.area_id','user_address.address','user_address.lat','user_address.lng','user_address.user_name','user_address.user_number','user_address.select_status','user_address.houseno','user_address.pincode','user_address.state','user_address.type')
            ->groupBy('user_address.address_id','user_address.city_id','user_address.area_id','user_address.address','user_address.lat','user_address.lng','user_address.user_name','user_address.user_number','user_address.select_status','user_address.houseno','user_address.pincode','user_address.state','user_address.type')
            ->where('user_address.user_id',$user_id)
