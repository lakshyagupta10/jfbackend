...
class categoryController extends Controller
{
    ...
    if(count($product)>0){
      ...
      $order = DB::table('product_varient')
        ...
        $data[]=array( 'product_id'=>$products->product_id ,'product_name'=>$products->product_name, 'products_image'=>$products->product_image,'is_pres'=>$products->is_pres,'is_id'=>$products->is_id,'isbasket'=>$products->isbasket, 'data'=>$order); 
        }
        }
        else{
            ...
            $product = DB::table('subcat')
        	 ...
        	 if(count($product)>0){
              ...
              $order = DB::table('product_varient')
                ...
                $data[]=array('category_id'=>$categorys->category_id , 'category_name'=>$categorys->category_name ,'product_id'=>$products->product_id ,'product_name'=>$products->product_name, 'product_image'=>$products->product_image,'is_pres'=>$products->is_pres,'is_id'=>$products->is_id,'isbasket'=>$products->isbasket, 'data'=>$order); 
                }
                }
                else{
