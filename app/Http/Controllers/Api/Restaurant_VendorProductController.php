...
class Restaurant_VendorProductController extends Controller
{
    public function resturant_products(Request $request)
    {
    ...
    public function resturant_addnewproduct(Request $request)
    {
        $vendor_id = $request->vendor_id;
    ...
    public function resturant_editnewproduct(Request $request)
    {
    ...
    public function resturant_updatenewproduct(Request $request)
    {
      $product_id=$request->product_id;
      $subcat_id=$request->subcat_id;
      $product_name=$request->product_name;
    ...
    public function resturant_deleteproduct(Request $request)
    {
        $product_id=$request->product_id;
        ...
        public function resturant_category(Request $request)
    {
      $vendor_id = $request->vendor_id;
	...
	else
	 {
      ...
      return $message;    }
         ...
         public function resturant_product(Request $request)
         {
           $vendor_id = $request->vendor_id;
           $subcat_id = $request->subcat_id;
     ...
     public function resturant_updateproductvariant(Request $request)
               {
                 $product_id=$request->product_id;
                 $subcat_id=$request->subcat_id;
                 $product_name=$request->product_name;
         ...
         public function resturant_addproductvariant(Request $request)
               {
                  $vendor_id=$request->vendor_id;
                 $product_id=$request->product_id;
                 $subcat_id=$request->subcat_id;
     ...
     public function resturant_addnewvariant(Request $request)
    {
        $vendor_id=$request->vendor_id; 
        $product_id = $request->product_id;
        $strick_price = $request->strick_price;
      ...
      public function resturant_updatevariant(Request $request)
    {
        $varient_id = $request->varient_id;
        $vendor_id = $request->vendor_id;
        $strick_price = $request->strick_price;
     ...
     public function resturant_deletevariant(Request $request)
    {
    ...
    public function resturant_addaddons(Request $request)
    {
        $vendor_id=$request->vendor_id; 
        $product_id = $request->product_id;
     ...
     public function resturant_addaddons_update(Request $request)
    {
     ...
     public function resturant_deleteaddon(Request $request)
    {
        $addon_id=$request->addon_id;
