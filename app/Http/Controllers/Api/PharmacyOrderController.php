...
class PharmacyOrderController extends Controller
{
 ...
 public function pharmacy_orderplaced(Request $request)
    { 
 ...
 public function pharmacy_order_cancel(Request $request)
    {
      $created_at = Carbon::now();     
      $cart_id = $request->cart_id;
 ...
 public function pharmacy_user_completed_orders(Request $request)
    {
      $user_id = $request->user_id;
  ...
  public function pharmacy_user_cancel_order_history(Request $request)
    {
      $user_id = $request->user_id;
      ...
      $order = DB::table('order_details')
            ...
            ->join ('restaurant_addons', 'resturant_product.product_id', '=', 'restaurant_addons.product_id')
                  ->select('resturant_variant.variant_id','resturant_product.product_name', 'resturant_product.product_image','order_details.qty','order_details.order_date','resturant_product.description','resturant_variant.unit','resturant_variant.quantity','order_details.order_cart_id','restaurant_addons.addon_name','restaurant_addons.addon_price','restaurant_addons.addon_id')
                  ->groupBy('resturant_variant.variant_id','resturant_product.product_name', 'resturant_product.product_image','order_details.qty','order_details.order_date','resturant_product.description','resturant_variant.unit','resturant_variant.quantity','order_details.order_cart_id','restaurant_addons.addon_name','restaurant_addons.addon_price','restaurant_addons.addon_id')
   ...
   public function pharmacy_user_ongoing_order(Request $request)
    {
      $user_id = $request->user_id;
