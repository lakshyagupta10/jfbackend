...
class ProfileController extends Controller
{
  ...
  public function packagingcharge(Request $request){
         $vendor_email=Session::get('vendor');
         $vendor=DB::table('vendor')
          ...
          $logo= DB::table('logo')
            ->first();
        return view('resturant.editvendor.packagingcharge',compact("vendor_email","vendor"));
 ...
 public function updatepackagingcharge(Request $request)
    {
     ...
     if(Session::has('vendor'))
     {
        ...
        ->update(['packaging_charges'=>$packaging_charge]);
