...
{
    public function vendordelivery_boy(Request $request)
    {
     ...
     public function vendorAdddelivery_boy(Request $request)
    {
     ...
     if(Session::has('vendor'))
     {
        ...
        $area= DB::table('vendor_area')
         ...
         return view('vendor.delivery_boy.adddelivery_boy',compact("vendor_email","vendor","area"));
     }  
     else
         {
            return redirect()->route('vendorlogin')->withErrors('please login first');
        ...
        public function vendorAddNewdelivery_boy(Request $request)
    {
    if(Session::has('vendor'))
     {
    ...
    public function vendorEditdelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
      {	
       ...
       $delivery_boy_id=$request->id;
    	 ...
    	 return view('vendor.delivery_boy.Editdelivery_boy',compact("vendor_email","vendor","delivery_boy_id","delivery_boy", "delivery_boy_area", "area"));
    ...
    public function vendorUpdatedelivery_boy(Request $request)
   {
     if(Session::has('vendor'))
      {
  ...
  public function vendordeletedelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
       {
    ...
    public function vendorconfirmdeliverystatus(Request $request)
    {
    ...
    public function cityadmindelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
     {
        ...
        ->get();
        return view('vendor.delivery_boy.cityadmindelivery_boy',compact("vendor_email","delivery_boy","vendor"));
     }
     else
     {
        return redirect()->route('vendorlogin')->withErrors('please login first');
