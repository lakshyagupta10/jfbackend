   ...
   public function AddNewproductvariant(Request $request)
    {
        ...
        $insert =  DB::table('product_varient')
                        ->insert(['product_id'=>$id,'strick_price'=>$strick_price, 'price'=>$price,'varient_image'=>$image, 'unit'=>$unit, 'quantity'=>$quantity,'description'=>$description,'vendor_id'=>$vendor_id, 'stock'=>$stock]);
     if($insert){
