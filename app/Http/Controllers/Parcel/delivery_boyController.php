...
{
    public function parceldelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
     {
        ...
        ->get();
        return view('parcel.delivery_boy.delivery_boy',compact("vendor_email","delivery_boy","vendor"));
     }
     else
     {
     ...
     public function parcelAdddelivery_boy(Request $request)
    {
     ...
     if(Session::has('vendor'))
     {
        ...
        $area= DB::table('vendor_area')
         ...
         return view('parcel.delivery_boy.adddelivery_boy',compact("vendor_email","vendor","area"));
     }  
     else
         {
            return redirect()->route('vendorlogin')->withErrors('please login first');
        ...
        public function parcelAddNewdelivery_boy(Request $request)
    {
    if(Session::has('vendor'))
     {
    ...
    public function parcelEditdelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
      {	
       ...
       $delivery_boy_id=$request->id;
    	 ...
    	 return view('parcel.delivery_boy.Editdelivery_boy',compact("vendor_email","vendor","delivery_boy_id","delivery_boy", "delivery_boy_area", "area"));
    ...
    public function parcelUpdatedelivery_boy(Request $request)
   {
     if(Session::has('vendor'))
      {
  ...
  public function parceldeletedelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
       {
    ...
    public function parcelconfirmdeliverystatus(Request $request)
    {
    ...
    public function parcelcityadmindelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
     {
        ...
        ->get();
        return view('parcel.delivery_boy.cityadmindelivery_boy',compact("vendor_email","delivery_boy","vendor"));
     }
     else
     {
        return redirect()->route('vendorlogin')->withErrors('please login first');
