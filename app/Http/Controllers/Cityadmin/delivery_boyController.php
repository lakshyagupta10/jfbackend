    ...
    if(Session::has('cityadmin'))
     {
        ...
        if($password!=$password2){
            ...
            $insert = DB::table('delivery_boy')
              ->insertGetId(['cityadmin_id'=>$cityadmin_id,'delivery_boy_name'=>$delivery_boy_name,'delivery_boy_image'=>$delivery_boy_image,'delivery_boy_phone'=> $delivery_boy_phone, 'delivery_boy_pass'=>$new_pass, 'created_at'=>$created_at,'dboy_comission'=>$comission]);
