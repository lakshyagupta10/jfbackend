...
{
    public function pharmacydelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
     {
        ...
        ->get();
        return view('pharmacy.delivery_boy.delivery_boy',compact("vendor_email","delivery_boy","vendor"));
     }
     else
     {
     ...
     public function pharmacyAdddelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
     {
        $vendor_email=Session::get('vendor');
        ...
        $area= DB::table('vendor_area')
         ...
         return view('pharmacy.delivery_boy.adddelivery_boy',compact("vendor_email","vendor","area"));
     }  
     else
         {
            return redirect()->route('vendorlogin')->withErrors('please login first');
        ...
        public function pharmacyAddNewdelivery_boy(Request $request)
    {
    if(Session::has('vendor'))
     {
        $vendor_email=Session::get('vendor');
        ...
        if($password!=$password2){
            ...
            $insert = DB::table('delivery_boy')
              ->insertGetId(['vendor_id'=>$vendor_id,'delivery_boy_name'=>$delivery_boy_name,'delivery_boy_image'=>$delivery_boy_image,'delivery_boy_phone'=> $delivery_boy_phone, 'delivery_boy_pass'=>$new_pass, 'created_at'=>$created_at,'dboy_comission'=>$comission]);
    ...
    public function pharmacyEditdelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
      {	
       $delivery_boy_id=$request->id;
    	 ...
    	 return view('pharmacy.delivery_boy.Editdelivery_boy',compact("vendor_email","vendor","delivery_boy_id","delivery_boy", "delivery_boy_area", "area"));
    ...
    public function pharmacyUpdatedelivery_boy(Request $request)
   {
     if(Session::has('vendor'))
      {
        $area_id=$request->area_id;
  ...
  public function pharmacydeletedelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
       {
        $delivery_boy_id=$request->id;
    ...
    public function pharmacyconfirmdeliverystatus(Request $request)
    {
    ...
    public function pharmacycityadmindelivery_boy(Request $request)
    {
     if(Session::has('vendor'))
     {
        ...
        ->get();
        return view('pharmacy.delivery_boy.cityadmindelivery_boy',compact("vendor_email","delivery_boy","vendor"));
     }
     else
     {
        return redirect()->route('vendorlogin')->withErrors('please login first');
