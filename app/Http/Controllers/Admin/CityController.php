...
class CityController extends Controller
{
    ...
    public function Addcity(Request $request)
    {
        ...
        $mapbox = DB::table('mapbox')
                ->first();
    	return view('admin.city.Addcity',compact("admin_email","admin","map1","mapset","mapbox","map"));
    ...
    public function AddInsertcity(Request $request)
    {
      ...
      $insert = DB::table('city')
    				->insert(['city_name'=>$city_name,'city_image'=>$city_image,'lat'=>$lat, 'lng'=>$lng, 'created_at'=>$created_at]);
    ...
    public function Editcity(Request $request)
{
     ...
     $admin=DB::table('admin')
        ...
        $mapbox = DB::table('mapbox')
                ->first();
	 return view('admin.city.Editcity',compact("admin_email","city","city_id","admin","map1","mapset","mapbox","map"));
}
