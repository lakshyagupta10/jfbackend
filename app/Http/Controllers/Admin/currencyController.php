...
class currencyController extends Controller
{
    public function currency(Request $request)
    {
    	         ...
    	         $currency= DB::table('currency')
    	 		          ->get();
    	         return view('admin.currency.currency',compact("admin_email","currency","admin"));
    ...
    public function Editcurrency(Request $request)
{
     ...
     $admin=DB::table('admin')
                ->where('admin_email',$admin_email)
                ->first();
	 return view('admin.currency.Editcurrency',compact("admin_email","currency","currency_id","admin"));
}
