    ...
    <header>
      <div class="aa-header" style="background-image: url('../images/home-image.jpg')">
        ...
        <div class="container aa-header-content text-left text-white">
          <div class="row">
            <div class="col-md-6 col-sm-12">
              ...
              <p style="font-size:20px">24/7 support</p>
              <ul class="py-1 list-unstyled">
                <li class="py-2" style="font-size:18px;"><i class="fa fa-envelope pr-4" aria-hidden="true"></i> info@jhatfat.com</li>
                <li class="py-2" style="font-size:18px;"><i class="fa fa-phone pr-4" aria-hidden="true"></i> +91 81718 65261</li>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 col-sm-12"><a class="aa-apple" onclick='alert("iOS application is Coming Soon, visit www.jhatfat.com/web to order")'>
                <div class="card">
                  <div class="row pb-3">
