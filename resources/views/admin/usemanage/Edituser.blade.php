                  ...
                  <form class="forms-sample" action="{{route('update-users',$user->user_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="user_password" value="{{$user->user_password}}"  placeholder="enter new password if you want to change the previous password">
                    </div>
                    ...
                    -->
                     <a href="{{route('edit-users',$user->user_id)}}" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
