...
<div class="content-wrapper">
		  ...
		  <div class="col-md-2">
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Cityadmin</h4>
                   @if (count($errors) > 0)
                      @if($errors->any())
                  ...
                  <form class="forms-sample" action="{{route('update-cityadmin',$cityadmin->cityadmin_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="autocomplete" value="{{$cityadmin->cityadmin_address}}" name="cityadmin_address" placeholder="Enter Address">
                   ...
                   <div class="form-group">
                      ...
                      <div class="autocomplete" style="width:100%;">
                           <input id="lng" type="hidden" name="lng" value="{{$cityadmin->lng}}">
                            ...
                            <input id="myInput" type="text" name="cityadmin_address" value="{{$cityadmin->cityadmin_address}}" placeholder="Place your Address">
