                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mt-3 mb-2">
                                        <a href="{{ route('adminallexcelgenerator') }}" class="btn btn-yellow btn-rounded btn-sm pl-5 pr-5 pt-2 pb-2 fs-14px font-weight-600"><i class="fa fa-wallet mr-2 ml-n2"></i>Download Report</a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo" style="min-height: 202px;">
                                ...
                                <!-- BEGIN card-body -->
                                <div class="card-body position-relative">
                                    <h5 class="text-white-transparent-8 mb-3 fs-16px">City Admin</h5>
                                    <h3 class="text-white mt-n1">{{$ongoing}}</h3>
                                    <div class="progress bg-black-transparent-5 mb-2" style="height: 6px">
                                        <div class="progrss-bar progress-bar-striped bg-white" style="width: 80%"></div>
                                    </div>
                                    <div class="text-white-transparent-8 mb-4"></i>here is the count <br />of all the City Admin</div>
