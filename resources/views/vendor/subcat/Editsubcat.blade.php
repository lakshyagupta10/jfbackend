                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('vendorUpdatesubcat',$subcat->subcat_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" value="{{$subcat->tax_slab}}" name="tax_slab" placeholder="Enter tax slab (leave empty if products are tax inclusive)">
                    </div>
                    <!-- <div class="form-group">-->
