        ...
        <table class="table table-bordered" id="example7" width="100%" cellspacing="0">
          ...
          @if(count($subcat)>0)
                        ...
                        <tr>
                            ...
                            <form class="form-inline" style="display: inline-block;" action="{{route('moveupsubcat',$subcats->subcat_id)}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <form class="form-inline" style="display: inline-block;" action="{{route('movedownsubcat',$subcats->subcat_id)}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
            				...
            				@if($subcats->hide)
                            <a href="{{route('hidesubcat',$subcats->subcat_id)}}" style="width: 28px; padding-left: 6px;" class="btn btn-dark"  style="width: 10px;padding-left: 9px;" style="color: #fff;"><i class="fa fa-eye-slash" style="width: 10px;"></i></a>
                            @else
                            <a href="{{route('hidesubcat',$subcats->subcat_id)}}" style="width: 28px; padding-left: 6px;" class="btn btn-light"  style="width: 10px;padding-left: 9px;" style="color: #fff;"><i class="fa fa-eye" style="width: 10px;"></i></a>
                            @endif
