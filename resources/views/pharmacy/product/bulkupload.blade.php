...
<form class="forms-sample" action="{{route('pharmacyimport')}}" method="post" enctype="multipart/form-data">
 {{csrf_field()}}
...
<button type="submit" class="btn btn-primary" style="width:15%;padding: 3px 0px 3px 0px;"><i class="material-icons"></i>Bulk product Upload</button>
  ...
  <a href="productdownload" class="btn btn-large pull-right"><i class="icon-download-alt"> </i> Download CSV </a>
...
<div class="container"><br>    
<form class="forms-sample" action="{{route('pharmacyimport_varients')}}" method="post" enctype="multipart/form-data">
 {{csrf_field()}}
...
<button type="submit" class="btn btn-primary" style="width:15%;padding: 3px 0px 3px 0px;"><i class="material-icons"></i>Bulk varient Upload</button>
  ...
  <a href="variantdownload" class="btn btn-large pull-right"><i class="icon-download-alt"> </i> Download CSV </a>
