                ...
                <div class="card-body">
                  <h4 class="card-title">Add Varient</h4>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('pharmacyAddNewproductvariant')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success mr-2">Submit</button>
                     ...
                     <a href="{{route('pharmacyvarient',$id)}}" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
