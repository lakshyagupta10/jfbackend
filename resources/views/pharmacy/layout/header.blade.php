	...
	margin-bottom: 25px;" >
			...
			@foreach($notes as $note)
				...
				<div class="p-2 text-center mb-n1">
					...
					<a class="dropdown-item d-flex align-items-center" href="{{route('pharmacyEditvendor',[$vendor->vendor_id])}}">Edit Profile <i class="fa fa-user-circle fa-fw ml-auto text-gray-400 f-s-16"></i></a>

						<div class="dropdown-divider"></div>
						<a class="dropdown-item d-flex align-items-center" href="{{route('pharmacyvendorLogout')}}">Log Out <i class="fa fa-toggle-off fa-fw ml-auto text-gray-400 f-s-16"></i></a>
					</div>
				</div>
			</div>
			<!-- END menu -->
