                ...
                <div class="card-body">
                  <h4 class="card-title">Add Delivery Boy</h4>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('pharmacyAddNewdelivery_boy')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="delivery_boy_comission" placeholder="Comission in Percentage like 10%" required>
                    </div>
                    ...
                    <button type="submit" class="btn btn-success mr-2">Submit</button>
                     ...
                     <a href="{{route('pharmacydelivery_boy')}}" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
