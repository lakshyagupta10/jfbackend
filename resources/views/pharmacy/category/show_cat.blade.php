  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      @if (count($errors) > 0)
                  ...
                  @endif
              @endif
        <a class="btn btn-success m-auto" style="float: right;" href="{{route('pharmacyAddCategory')}}">Add</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <tr>
            ...
            <td>{{$adminCategories->cat_name}}</td>
              ...
              <a href="{{route('pharmacyDeleteCategory', [$adminCategories->resturant_cat_id])}}" class="btn btn-danger">Delete</a>
        </td>
        </tr>
              @php $i++; @endphp
                @endforeach
