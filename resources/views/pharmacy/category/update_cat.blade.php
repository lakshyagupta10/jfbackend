              ...
              <div class="card">
                <div class="card-body">
                  ...
                  @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('pharmacyUpdateCategory', [$category->resturant_cat_id])}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    <a href="{{route('pharmacycategory')}}" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
