                ...
                <div class="card-body">
                  <h4 class="card-title">Edit Deal products</h4>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('pharmacyUpdateDealproduct', $deal_p->deal_product_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                 ...
                 <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" value="{{$deal_p->deal_price}}" name="deal_price" placeholder="Deal Price">
                    </div>  
                    ...
                    <a href="{{route('pharmacydealroduct')}}" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
