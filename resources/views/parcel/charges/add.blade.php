		  ...
		  <div class="col-md-2">
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="form-group">
					<label for="exampleInputName1">Enter Charges Per KM</label>
					<input type="text" class="form-control" name="parcel_charge" placeholder="Enter Charges">
				</div>

				<div class="form-group">
					<label for="exampleInputName1">Charge Description </label>
					<textarea class="form-control" name="charge_description" placeholder="Charge Description "></textarea>
				</div>  
