		 ...
		 <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{url('parcel/insert-city')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                     @if (count($errors) > 0)
                    @if($errors->any())
                 ...
                 @endif
                    @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="autocomplete" name="city_name" placeholder="Enter Address">
                   ...
                   <div class="form-group">
                      ...
                      <div class="autocomplete" style="width:100%;">
                           <input id="lng" type="hidden" name="lng">
                            ...
                            <input id="myInput" type="text" name="city_name" placeholder="Place your Address">
