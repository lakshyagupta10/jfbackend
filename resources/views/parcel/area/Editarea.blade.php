                ...
                <div class="card-body">
                  <h4 class="card-title">Update Area</h4>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('parcelUpdatearea',$area->vendor_area_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    <!--      <option value="yes" @if($area->cod == 'yes') selected @endif>Yes</option>-->
                    <!--      <option value="no" @if($area->cod == 'no') selected @endif>No</option>-->
                    <!--  </select>-->
                    <!--</div>-->
