...
<html lang="en-US">
  <head>
    ...
    <link href="{{asset('/css/paper-kit.min.css?ver=1.1.0')}}" rel="stylesheet">
    <link href="{{asset('/css/main.css?ver=1.1.0')}}" rel="stylesheet">
  </head>
  <body id="top">
    <header>
      <div class="aa-header" style="background-image: url('../images/home-image.jpg')">
        <nav class="navbar navbar-expand-md">
          <div class="container"><a class="navbar-brand px-0 py-0" href="#"><img src="{{asset('/images/logo.jpeg')}}" width="100px" class="logo">Jhatfat Delivery</a>
            <div class="collapse navbar-collapse">
              <ul class="navbar-nav ml-auto">
                <!-- <li class="nav-item"><a class="nav-link" href="#">Home</a></li> -->
                <!-- <li class="nav-item"><a class="nav-link" href="#features">Features</a></li> -->
                <!-- <li class="nav-item"><a class="nav-link" href="#pricing">Pricing</a></li> -->
                <li class="nav-item"><a class="btn btn-round" style="padding:10px; background-color:#ffffff;color:#66615b;text-transform:None" href="https://play.google.com/store/apps/details?id=com.jhatfat"><i class="fa fa-android fa-4x" style="color:#66615b"></i> Android</a></li>
                <li class="nav-item"><a class="btn btn-round" style="padding:10px; background-color:#ffffff;color:#66615b;text-transform:None" href="https://apps.apple.com/in/app/jhatfat/id6443864395"><i class="fa fa-apple fa-4x" style="color:#66615b"></i> iOS</a></li>
                <li class="nav-item"><a class="btn btn-round" href="https://jhatfat.com/web/#">Order Now</a></li>
              </ul>
            </div>
          </div>
        </nav>
                <div class="container">
          <div class="h2 text-center text-title text-white pb-5">Download Jhatfat App Now </div>
          <div class="row">
            <div class="col-md-6 col-sm-12"><a class="aa-apple" href="https://apps.apple.com/in/app/jhatfat/id6443864395">
                <div class="card">
                  <div class="row pb-3">
                    <div class="col-lg-6 col-md-12 aa-download-icon"><center><i class="pt-4 fa fa-apple fa-4x" aria-hidden="true" style="padding: 5px;"></i></center></div>
                    <div class="col-lg-6 col-md-12 aa-download-icon-detail">
                      <div class="h4 pb-1">Download</div>
                      <p class="text-muted">Download from App Store</p>
                    </div>
                  </div>
                </div></a></div>
            <div class="col-md-6 col-sm-12"><a class="aa-android" href="https://play.google.com/store/apps/details?id=com.jhatfat">
                <div class="card">
                  <div class="row pb-3">
                    <div class="col-lg-6 col-md-12 aa-download-icon"><center><i class="pt-4 fa fa-android fa-4x" aria-hidden="true" style="padding: 5px;"></i></center></div>
                    <div class="col-lg-6 col-md-12 aa-download-icon-detail">
                      <div class="h4 pb-1">Download</div>
        ...
        <div class="container aa-header-content text-left text-white">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
              <h1 class="text-white mb-4">We Deliver Almost Everything</h1>
              <p>Groceries, Food, Pickup and Drop and more....</p>
              <ul class="py-1 list-unstyled">
                <li class="py-2"><i class="fa fa-check-circle pr-4" aria-hidden="true"></i> Order From Multiple Shops</li>
                <li class="py-2"><i class="fa fa-check-circle pr-4" aria-hidden="true"></i> Free Delivery @299 per month</li>
                <li class="py-2"><i class="fa fa-check-circle pr-4" aria-hidden="true"></i> Order From your favurite stores and street vendors</li>
              </ul><a class="mt-4 btn btn-outline-neutral btn-round" href="https://jhatfat.com/web/#">Order Now</a>
              <!--<a class="mt-4 btn btn-outline-neutral btn-round" style="padding:10px;text-transform:None"href="https://play.google.com/store/apps/details?id=com.jhatfat"><i class="fa fa-android fa-2x"></i>     Android</a>-->
              <!--<a class="mt-4 btn btn-outline-neutral btn-round" style="padding:10px;text-transform:None;"href="https://apps.apple.com/in/app/jhatfat/id6443864395"><i class="fa fa-apple fa-2x"></i>     iOS</a>-->
              
            </div>
            <div class="col-md-6 col-sm-12 text-right"><img class="img-fluid" src="images/1.png" alt="Image" width="280px"></div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          <div class="aa-testimonials-body">
            ...
            <div class="row pt-3">
              <div class="col-lg-5 col-md-12"><img class="img-fluid" src="images/user1.jpg" alt="Face 1"/></div>
              <div class="col-lg-7 col-md-12 pt-3">
                <div class="h5">Patrick Harry</div>
                <p class="text-muted">CEO, Awesome Inc.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-3">
          <div class="aa-testimonials-body">
            <p>Awesome App is awesome and I can't imagine working on my projects without it. It has saved me countless hours of time and has increased my productivity.</p>
            <div class="row pt-3">
              <div class="col-lg-5 col-md-12"><img class="img-fluid" src="images/user2.jpg" alt="Face 2"/></div>
              <div class="col-lg-7 col-md-12 pt-3">
                <div class="h5">Jeanne Lawson</div>
                <p class="text-muted">Design, Awesome Inc</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-3">
          <div class="aa-testimonials-body">
            <p>Awesome App is awesome and I can't imagine working on my projects without it. It has saved me countless hours of time and has increased my productivity.</p>
            <div class="row pt-3">
              <div class="col-lg-5 col-md-12"><img class="img-fluid" src="images/user3.jpg" alt="Face 3"/></div>
              <div class="col-lg-7 col-md-12 pt-3">
                <div class="h5">Robin Barnes</div>
                <p class="text-muted">Developer, Awesome Inc</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <footer class="footer-black aa-footer">
      <div class="container py-5">
        <div class="row text-center">
          <div class="col-md-12"><a class="btn btn-link btn-neutral" href="https://www.facebook.com/JHATFAT"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a><a class="btn btn-link btn-neutral" href="https://www.instagram.com/jhatfatdelivery_dehradun/"><i class="fa fa-instagram fa-2x" aria-hidden="true"></i></a></div>
          <div class="col-md-12">
            <p class="mt-3">Copyright &copy; Jhatfat Delivery. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
    <script src="{{asset('/scripts/jquery.min.js?ver=1.1.0')}}"></script>
    <script src="{{asset('/scripts/jquery-ui-1.12.1.custom.min.js?ver=1.1.0')}}"></script>
    <script src="{{asset('/scripts/popper.min.js?ver=1.1.0')}}"></script>
    <script src="{{asset('/scripts/bootstrap.min.js?ver=1.1.0')}}"></script>
    <script src="{{asset('/scripts/paper-kit.js?ver=1.1.0')}}"></script>
