		...
		<div id="sidebar" class="app-sidebar">
			...
			<div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
				...
				<div class="menu">
					...
					<div class="menu-item">
						<a href="{{route('packagingcharge')}}" class="menu-link">
							<span class="menu-icon"><i class="fa fa-book"></i></span>
							<span class="menu-text">Packaging Charges</span>
						</a>
					</div>
					<div class="menu-item">
						<a href="{{route('resturanttaxes')}}" class="menu-link">
							<span class="menu-icon"><i class="fa fa-book"></i></span>
							<span class="menu-text">Taxes</span>
						</a>
					</div>
					<div class="menu-divider"></div>
					<div class="menu-header">Area | Delivery Boy | Incentive</div>
					<div class="menu-item">
