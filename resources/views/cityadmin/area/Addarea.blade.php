                ...
                <div class="card-body">
                  <h4 class="card-title">Add Area</h4>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('AddNewarea')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    
                     @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                     <div class="form-group">
                      <label for="autocomplete">Address</label>
                      <input type="text" class="form-control" id="autocomplete" name="area_name" placeholder="Search your Area">
                   ...
                   <div class="form-group">
                      ...
                      <div class="autocomplete" style="width:100%;">
                           <input id="lng" type="hidden" name="lng">
                            ...
                            <input id="myInput" type="text" name="area_name" placeholder="Search your Area">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputName1" name="delivery_charge" placeholder="Delivery Charge">
                    </div>
