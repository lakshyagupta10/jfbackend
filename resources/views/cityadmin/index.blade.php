...
@section ('content')
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
				...
				Hi,{{$cityadmin->cityadmin_name}}. <small>here's what's happening with your store today.</small>
			</h1>
          </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal" style="min-height: 202px;">
                                ...
                                <!-- BEGIN card-body -->
                                <div class="card-body position-relative">
                                    <h5 class="text-white-transparent-8 mb-3 fs-16px">Total Vendors</h5>
                                    <h3 class="text-white mt-n1">{{$complete}}</h3>
                                    <div class="progress bg-black-transparent-5 mb-2" style="height: 6px">
                                        <div class="progrss-bar progress-bar-striped bg-white" style="width: 50%"></div>
                                    </div>
                                    <div class="text-white-transparent-8 mb-4"></i>here all your partners <br />add by city Admin</div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo" style="min-height: 202px;">
                                ...
                                <!-- BEGIN card-body -->
                                <div class="card-body position-relative">
                                    <h5 class="text-white-transparent-8 mb-3 fs-16px">Delivery Boys</h5>
                                    <h3 class="text-white mt-n1">{{$cityadmin1}}</h3>
                                    <div class="progress bg-black-transparent-5 mb-2" style="height: 6px">
                                        <div class="progrss-bar progress-bar-striped bg-white" style="width: 80%"></div>
                                    </div>
                                    <div class="text-white-transparent-8 mb-4"></i>here is the count <br />of all the delivery boys</div>
                ...
                <div class="col-xl-6">
                     ...
                     <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2">
                                <div class="flex-grow-1">
                                    <h5 class="mb-1">Today's Order</h5>
                                    <div class="fs-13px">Check all store Today's Order</div>
                                </div>
                                ...
                                <table class="table table-borderless mb-0">
                                    <thead>
                                        <tr class="text-dark">
                                            ...
                                            <th class="text-right pr-0">Vendor Name</th>
                         ...
                         <tr>
                            <td>{{$i}}</td>
                                            ...
                                            <td class="text-center"><span class="label bg-success-transparent-2 text-success" style="min-width: 60px;">{{$recent_orders->order_status}}</span></td>
                                            <td class="text-right pr-0">{{$currency->currency_sign}}{{$recent_orders->rem_price}}</td>
                                            <td class="text-right pr-0">{{$recent_orders->vendor_name}}</td>
                      ...
                      @endif
                                ...
                                {!! $recent_order->links("pagination::bootstrap-4") !!}
                            </div>
