...
<div class="content-wrapper">
		  ...
		  <div class="col-md-2">
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Delivery Charges</h4>
                   @if (count($errors) > 0)
                      @if($errors->any())
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('AddNewdelivery_charges',$delivery_charge_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
