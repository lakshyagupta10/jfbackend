		  ...
		  <div class="col-md-2">
            ...
            <div class="col-md-8 grid-margin stretch-card">
             ...
             <!--       </div>-->
                       ...
                       <div class="form-group">
                    <label for="exampleFormControlSelect3">Vendor Category</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="vendor_name" placeholder="Enter vendor Name">
                    </div>
                         @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                     <div class="form-group">
                      <label for="autocomplete">Address</label>
                      <input type="text" class="form-control" id="autocomplete" name="vendor_address" placeholder="Enter Address">
                   ...
                   <div class="form-group">
                      ...
                      <div class="autocomplete" style="width:100%;">
                           <input id="lng" type="hidden" name="lng">
                            ...
                            <input id="myInput" type="text" name="vendor_address" placeholder="Place your Address">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="vendor_email" placeholder="Enter vendor Email">
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="comission" placeholder="Enter Comission in Percentage">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Delivery Range</label>
                      <input type="number" class="form-control" id="exampleInputName1" name="range" placeholder="How many KM you Delivered">
                    </div>
                     <div class="form-group">
